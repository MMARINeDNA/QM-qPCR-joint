...
While trawling and other traditional sampling methods have been the fundamental for directly measuring species abundance and biomass, it is often impractical for species inhabiting inaccessible habitats, occurring at low densities, or being fragile and easily injured during capture. By contrast, eDNA sampling is non-invasive and captures information on a broader range of taxa, including those that are difficult or impossible to study with traditional gear. As such, eDNA offers an additional, valuable source of data that complements traditional stock assessment methods for commercially important species while providing critical insights into the abundance and distribution of elusive or understudied species.

Here, we develop quantitative estimates for a diverse group of fish species spanning different ecological niches across 10 degrees of latitude along the US west coast entirely from residual genetic material (eDNA). This approach integrates single- and multi-species genetic approaches to create quantitative, multi-species, three-dimensional distribution maps, leveraging models and frameworks established in previous studies [@shelton2022, @guri2024a, @shelton2023, @allan2023]. By calibrating metabarcoding data -- correcting raw species observations to their initial proportions using a mock community [@shelton2023] -- and using the absolute eDNA quantity of a reference species (here Pacific Hake (*Merluccius productus*)), initial estimated proportions can be expanded into absolute abundance estimates for each species [@guri2024a]. We subsequently spatially smoothed the estimated eDNA quantities to generate species distribution maps [@liu2023]. Our study illustrates how eDNA can simultaneously complement distributional and abundance information for well-studied species while revealing new biological details for ecologically important but understudied species. We present results for 13 fish species to illustrate the approach, but note that it immediately generalizes to any ecological community of interest.
...
Northern anchovy (*Engraulis mordax*) is epipelagic,  primarily inhabiting waters above the thermocline between Baja California and British Columbia. While larvae and juveniles typically occupy the upper 50m, adults move to 100m during the day to avoid predators. The species has a major spawning peak in July (our sampling period), centered on the nutrient-rich water near the Columbia River plume [@litz2008]. Our eDNA estimates mirrored these ecological patterns, revealing high concentrations in surface waters at northern latitudes (Fig. \ref{Fig1}), particularly near the Columbia River outflow , possibly reflecting a mix of adults, larvae, and eggs.

Pacific sardine (*Sardinops sagax*) another epipelagic species, favors slightly warmer temperatures (SST 18–24°C vs. 10–14°C for the anchovy) and typically inhabits slightly greater depths [@nevarez-martinez2001]. Our estimated eDNA patterns tracked these known differences with sardine eDNA peaking at 41°N (range 40°–45°), while anchovy eDNA peaking at 43.5°N (range 42°–48°; Fig. \ref{Fig4}) indicating how eDNA can capture subtle yet meaningful differences in habitat preferences.

### **Mid-water**

Widow rockfish (*Sebastes entomelas*) are distributed from northern Baja California to southern Alaska and in summer are commonly found between 100-250m, with juveniles occupying somewhat shallower habitats (50 - 150m) [@reynolds2001] and closer to the coast [@quigley2024]. Individuals form dense feeding schools at night -- preying on euphausiids, salps, and small fishes -- and disperse at dawn [@reynolds2001]. The eDNA concentration estimates for the rockfish are consistent with the shallower end of these expected habitats, with the 50m samples capturing the majority of the signal (Fig. \ref{Fig4}). 

Northern lampfish (*Stenobrachius leucopsarus*) is an abuntant species throughout the coast, living at 400 - 700m during the day and 20 - 200m at night [@moku2000]. This dial vertical migration (DVM) is thought to balance predator avoidance with a diet of krill, amphipods, and copepods [@moku2000; @suntsov2008]. eDNA patterns for the species are again consistent with the species' ecology; we find high eDNA concentrations throughout the sampled water column but notably lower concentrations at the surface.

### **Benthic**

[@Ryan can you please emphasize that these are common species about which relatively little is known]

Dragonfish (*Tactostoma macropus*) is a mesopelagic to bathypelagic species found in the subarctic and transitional North Pacific typically between 40 to 50 degree latitude [@kawaguchi1993]. Adults primarily occupy depths of 300–900 meters, while larvae reside in warmer, more productive surface layers (0–60m) right after hatching (summer), feeding on copepods and krill [@kawaguchi1993]. As they mature, juveniles transition to deeper waters, performing diel vertical migrations (DVM) following krill to depths around 100 meters [@willis1982; @kawaguchi1993]. Such bimodal lifestyle activity, is reflected through the eDNA concentration estimates (Fig. \ref{Fig4}) where the signal from larvae and juveniles is predominantly present near Columbia river plume (Fig. \ref{Fig1}) which has nutrient rich water and the adults (i.e., 500m deep signal) from mainly two hotspots, near Columbia river and northern California.

Dover sole (*Microstomus pacificus*) is a deep-water flatfish inhabiting depths between 200 and 1200 meters along the Pacific coast, from southern California to the Bering Sea [@drazen2007;@brodziak2000;@drazen2012]. This species exhibits ontogenetic migration, with individuals moving progressively deeper as they grow, following the seafloor as they age [@vetter1994;@hunter1990]. The eDNA concentration estimates aligned with this pattern, showing high concentrations mostly in deep water samples (Fig. \ref{Fig4} A) and in shallow samples when located near the seabed (Fig. \ref{Fig1}). Additionally two distinct patches of were observed, one in north of Oregon and the other in northern California (Fig. \ref{Fig1} & Fig. \ref{Fig4} B). 
...
Correlation analyses of estimated eDNA concentrations among species (Fig. \ref{Fig2}) revealed that species sharing similar ecological habitats -- particularly concerning depth -- tended to cluster together. This pattern of correlation and segregation was gradual when species were ordered from the upper to the lower parts of the water column (Fig. \ref{Fig2}), aligning closely with their known habitat preferences.

The three major groups of species clustered in this study (i.e., surface, midwater, and deepwater) showed distinct correlations patterns. Within the surface species, a subtle subdivision including chub mackerel and sardines exhibited slightly distinct correlation patterns compared to the other surface species. These species showed little to negative correlation with pacific herring and mesopelagic fish. This subgroup predominantly occupies the southern area of the US coast, characterized by warmer waters (Fig. \ref{Fig4}) while other epipelagic species (and mesopelagic) are predominantly found in the northern, colder waters. Additionally, the remaining surface species (northen anchovy, eulachon, jack mackarell and pacific herring) showed additional correlation to midwater species (Fig. \ref{Fig4}), suggesting that their habitat occupancy overlaps with both surface and midwater zones as they prefer surface water (first surface subgroup) but generally colder environments (mesopelagic fish). This indicated that eDNA is capturing not only depth differences but also habitat preferences [@Ryan please help to rephrase the last two sentences]. An evident species for this scenario is Pacific herring which is predominantly aggregated around 48°N but occupies the surface water while the south epipelagic is around 42°N and occupies also the surface water, but the correlation plots indicated that they are different suggesting that eDNA can distinguish habitat differences althuogh the species distribution is wide and species occyping similar depth zones [@Ryan please help to rephrase this sentence].

Deepwater species formed a distinct group of their own, exhibiting little to no correlation with species from other depth zones appart from *Stenobrachius leucopsarus* and *Tactostoma macropus* which correlated more with the opposite groups (deepwater and midwater respectively). Classifying deepwater species presents challenges due to the vagueness of their definitions. Depending on the study’s purpose, these species may be categorized differently, leading to them interchangeably swapping places between mesopelagic and bathypelagic classifications [@Ryan please help to rephrase this paragraph].
...
Species richness exhibited a pronounced depth-dependent gradient, with the highest richness observed at the surface and a progressive decline with increasing depth (Fig. \ref{Fig3} A). This pattern is consistent with the species composition included in this study, which predominantly comprises epipelagic and mesopelagic species, but also reflects the expectation that habitat availability is greatest near the surface as indicated by the presence of deepwater species near the surface. Surface waters not only serve as habitats for epipelagic species but also provide critical environments for the eggs, larvae, and juvenile stages of meso- and bathypelagic species; hence, higher species accumulation is to be expected in the upper layer of the water column. Furthermore, the spatial distribution of species richness corresponds strongly with the influence of Columbia River plume (Fig. \ref{Fig3} A), which extends both north and south of the river mouth. The nitrate-rich water discharged from the river interacts with ocean currents creating upwelling zones (predominantly during summer) where nutrient-rich deep water is brought to the surface. This upwelling enhances phytoplankton and zooplankton production, thereby creating optimal conditions for the early life stages of fish and secondary consumers, supporting higher species richness near the surface (Fig. \ref{Fig4} B). Additionally the estimated eDNA accumulation follows somewhat a similar pattern to richness with the highest aggregation of foraging fish near Heceta bank (Fig. \ref{Fig3} B). The highest contributors to the peak of total estimated eDNA are the two foraging fish Northern anchovy and Sardine indicating patters of co-occurance and shared foragin habitat zones (Fig. \ref{Fig4} B). Such patters coincides with the previously known productive area for commercial (maybe foraging) species. [@Ryan please help to rephrase the last two sentences].

[@Ryan check if this paragraph is ok in general]
