...
We find spatial patterns of DNA concentrations reflect the distributions of commercially important coastal-pelagic fish species with remarkable fidelity, in three dimensions and across ten degrees of latitude (Fig 1: Anchovy, Sardine, herring; Supplement mackerel). For other high-biomass species otherwise lacking well-described distributions, we provide the first species distribution models (Fig 1, other species). We find correlated patterns of eDNA concentrations among species reflecting clusters of species with similar habitat preferences (Fig 2). Emergent patterns of species richness indicate variability in coastal pelagic fish diversity and abundance associated with [primary productivity, etc]. Particularly for forage fish species — critical high-biomass links in marine food webs, but difficult to survey with traditional methods — molecular methods offer a tractable and quantitative index of abundance over large spatial scales.
