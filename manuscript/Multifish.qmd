...
Species richness exhibited a pronounced depth-dependent gradient, with the highest richness observed at the surface and a progressive decline with increasing depth (Fig. 3). This pattern is consistent with the species composition included in this study, which predominantly comprises epipelagic and mesopelagic species, and reflects the expectation that habitat availability is greatest near the surface. Surface waters not only serve as habitats for epipelagic species but also provide critical environments for the eggs, larvae, and juvenile stages of meso- and bathypelagic species; hence, higher species accumulation is to be expected in the upper layer of the water column. The species overlap map (Fig, 3) revealed a richness hotspot located along the Oregon coast, a region representing the confluence of different thermal habitats where both cold- and warm-water species co-occur.

Furthermore, the spatial distribution of species richness corresponds strongly with the influence of Columbia River plume, which extends both north and south of the river mouth. The nitrate-rich water discharged from the river interacts with ocean currents creating upwelling zones where nutrient-rich deep water is brought to the surface. This upwelling enhances phytoplankton and zooplankton production, thereby creating optimal conditions for the early life stages of fish and secondary consumers, supporting higher species richness near the surface (Fig. 3).
