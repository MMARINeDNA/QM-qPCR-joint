...
# write_rds(stan_data_joint,here('data','Zenodo','Joint_mod_data_input.rds'))
```
...
alphap
# write_rds(mocksMod,here('data','Zenodo','Mock_mod_output.rds'))
```
...
# write_rds(jointMod,here('data','Zenodo','Joint_mod_output.rds'))
```
