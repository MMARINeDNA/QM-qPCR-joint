...
stan_post <- readRDS(here('data','Models','Output','jointMod_v6.rds'))
preds <- read_rds(here('data','all_smooth_predictions.rds'))

# Raw data
# stan_data_joint <- readRDS(here('CEG_run_nov','Input','stan_data_joint.rds'))
stan_data_joint <- readRDS(here('data','Models','Input','stan_data_joint_v6.rds'))
...
mfu <- read.csv('/Users/gledguri/Library/CloudStorage/OneDrive-UW/UW/QM-qPCR-joint-main_git_clone/data/mfu_raw.csv')
# mfu <- stan_data_joint$sample_data_labeled %>% 
