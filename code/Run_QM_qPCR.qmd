...
formatted_qPCR_data <- format_qPCR_data(qPCR_unknowns=qPCR_unk,
                                   ...
                                   unk_covariates=c("wash_idx","day"),cov_type = c("continuous","continuous"),
                                   unk_offset =c("dilution"))

stan_qPCR_data <- prepare_stan_data_qPCR(formatted_qPCR_data)

# linking data
qPCR_mb_link <- prepare_stan_qPCR_mb_join(mfu,unk_formatted = formatted_qPCR_data$qPCR_unk,link_species = "Merluccius productus")
...
jointMod = stan(file = m ,
                ...
                control = list(adapt_init_buffer = 150,
                                  ...
                                  adapt_delta=0.9,
                                  metric="diag_e"),
                init = stan_init_f1(n.chains,N_obs_mb = stan_data_joint$N_obs_mb_samp,N_species = stan_data_joint$N_species,Nplates=stan_data_joint$Nplates),
                refresh = 10,
                boost_lib = NULL,
                sample_file=NULL
                )
