...
stan_post <- readRDS(here('data','Zenodo','Joint_mod_output.rds'))
stan_post_mock <- readRDS(here('data','Zenodo','Mock_mod_output.rds'))
preds <- read_rds(here('data','Zenodo','Log_D_est_smoothed.rds'))

# Raw data
stan_data <- readRDS(here('data','Zenodo','Joint_mod_data_input.rds'))
...
#   select(-Species) %>%
#   left_join(.,stan_data[["sp_list"]],by='species_idx')
# 
...
fit <- read_rds(here('data','Zenodo','Log_D_est.rds')) %>% 
...
# mfu <- stan_data$sample_data_labeled %>% 
#   left_join(meta,by='tubeID') %>% 
#     pivot_longer(cols = sp_1:sp_13,
#                 names_to = 'species_idx',
#                 values_to = 'reads') %>% 
#     mutate(species_idx=gsub('sp_','',species_idx)) %>% 
#     mutate(species_idx=as.numeric(species_idx)) %>% 
#     left_join(.,stan_data$sp_list,by='species_idx')
...
depth_scheme <- image_read(here('plots','ppt_figures','Literature_species_dist_1.jpg'))
...
# ggsave(file = here('plots','1_Figure_1.jpg'),
#        fig_1,
...
# ggsave(file = here('plots','5_Supplementary_Figure_1.jpg'),
#        sf1,
#        width = 10,height = 13,units='in',bg='white')
```
...
# ggsave(file = here('plots','6_Supplementary_Figure_2.jpg'),
#        sf2,
...
# sf3
# ggsave(file = here('plots','7_Supplementary_Figure_3.jpg'),
#        sf3,
#        h=8,w=10,units='in',bg='white')
```
...
sf4
# ggsave(file = here('plots','8_Supplementary_Figure_4.jpg'),
#        sf4,
...
# sf5_raw <-
#   cowplot::plot_grid(sf5_a,sf5_b,sf5_d,sf5_e,sf5_c,leg1,labels = c('A','B','C','D','E'),ncol = 2,align = 'v')
# sf5 <-
#   cowplot::plot_grid(sf5_raw,leg1,rel_widths = c(7,3))
# ggsave(file = here('plots','9_Supplementary_Figure_5_new.jpg'),
#        sf5,
#        h=12,w=8,units='in',bg='white')

sf5 <-
  cowplot::plot_grid(sf5_a,sf5_b,sf5_d,sf5_e,sf5_c,leg1,labels = c('A','B','C','D','E'),ncol = 2,align = 'v')

sf5
# ggsave(file = here('plots','9_Supplementary_Figure_5.jpg'),
#        sf5,
...
sf6
# ggsave(file=here('plots','10_Supplementary_Figure_6.jpg'),
#        sf6,
...
# ggsave(file=here('plots','Supplementary Figure 7.jpg'),
#        sf7,
