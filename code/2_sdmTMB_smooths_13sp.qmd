...
```{r,eval=F}
# fitted model object
jm_out <- read_rds(here('data','Models','Output','jointMod_v6.rds'))
stan_data <- read_rds(here('data','Models','Input','stan_data_joint_v6.rds'))
...
# save
write_rds(all_preds,here('data','all_smooth_predictions.rds'))
```
