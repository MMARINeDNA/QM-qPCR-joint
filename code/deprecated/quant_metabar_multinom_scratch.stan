...
transformed parameters {
  ...
  vector[N_b_samp_col] beta[N_species]; // array of coefficients (abundances relative to reference taxon, for each species and sample)
  ...
  matrix[N_species,N_obs_mock] prob_mock_t;
    ...
    // add over dispersion by making the intercept term (beta) have a normal distribution.
